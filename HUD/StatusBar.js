...
export class StatusBar {
    ...
    drawTime(context) {
        ...
        const flasFrame = TIME_FRAME_KEYS[Number(this.useFlashFrames)];

        this.drawFrame(context, `${flasFrame}-${timeString.charAt(0)}`, 178, 33);
        this.drawFrame(context, `${flasFrame}-${timeString.charAt(1)}`, 194, 33);
    }
